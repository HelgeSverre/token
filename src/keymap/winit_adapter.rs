...
pub fn keystroke_from_winit(
    ...
    let key_code = match logical_key {
        ...
        Key::Named(named) => match named {
            ...
            NamedKey::F13 => Some(KeyCode::F(13)),
            NamedKey::F14 => Some(KeyCode::F(14)),
            NamedKey::F15 => Some(KeyCode::F(15)),
            NamedKey::F16 => Some(KeyCode::F(16)),
            NamedKey::F17 => Some(KeyCode::F(17)),
            NamedKey::F18 => Some(KeyCode::F(18)),
            NamedKey::F19 => Some(KeyCode::F(19)),
            NamedKey::F20 => Some(KeyCode::F(20)),
            NamedKey::F21 => Some(KeyCode::F(21)),
            NamedKey::F22 => Some(KeyCode::F(22)),
            NamedKey::F23 => Some(KeyCode::F(23)),
            NamedKey::F24 => Some(KeyCode::F(24)),
