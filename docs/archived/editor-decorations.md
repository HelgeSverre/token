...
> **Priority:** P2 (Important) — prerequisite for [find-enhancements](find-enhancements.md), [diff-gutter](../feature/diff-gutter.md), [folding-basic](../feature/folding-basic.md), and [LSP diagnostics](lsp-integration.md)
